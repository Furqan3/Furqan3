...
export default function ProjectsClient({ projects, featuredProject }) {
	...
	// Use the featured project, fall back to first visible project
	const highlight = featuredProject || projects?.[0] || null;
	const highlightImages = highlight?.images?.filter(Boolean) || [];
							...
							<div className="mt-3 flex gap-2 flex-wrap">
								...
								{highlight.preview && (
									<Button variation="secondary">
										<a href={highlight.preview} target="_blank" rel="noopener noreferrer">
											Preview
										</a>
									</Button>
								)}
