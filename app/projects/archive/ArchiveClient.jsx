	...
	return (
		<main className="overflow-hidden">
			...
			<div className="min-h-screen w-screen mt-10 md:mt-0 p-10 flex justify-center items-center flex-col mb-10">
				...
				<div className="mx-auto container md:px-10 grid grid-cols-1 mb-5">
								...
								<tr key={index} className="hover:shadow-md transition-all ease duration-500">
									...
									<td>
										<div className="flex flex-row justify-center items-center">
											{project.code && (
												<a href={project.code} title="GitHub" target="_blank" rel="noopener noreferrer">
													<FontAwesomeIcon icon={faGithub} className="text-xl mr-2" />
												</a>
											)}
											{project.preview && (
												<a href={project.preview} title="Preview" target="_blank" rel="noopener noreferrer">
