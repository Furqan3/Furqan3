				...
				<div className="mx-auto w-[82%] max-w-screen-2xl grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden">
					<motion.div
						...
						<motion.p
							...
							Hi! I&rsquo;m Furqan, a Computer Engineer
				...
				<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
					...
					<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
						...
						<motion.p
							...
							<a href="mailto:fahmad.ktk@gmail.com?subject=Hello&body=Hello Furqan,">
								fahmad.ktk@gmail.com
							</a>
						</motion.p>
						{/* icons */}
						<div className="flex justify-center items-center space-x-4">
							<motion.a
								href="mailto:fahmad.ktk@gmail.com?subject=Hello&body=Hello Furqan,"
							...
							<motion.a
								href="https://www.linkedin.com/in/furqan-ktk/"
								target="_blank"
								rel="noopener noreferrer"
